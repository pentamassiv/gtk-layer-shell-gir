...
[![dependency status](https://deps.rs/crate/gtk-layer-shell/0.3.0/status.svg)](https://deps.rs/crate/gtk-layer-shell/0.3.0)
[![Crate](https://img.shields.io/crates/v/gtk-layer-shell-sys.svg)](https://crates.io/crates/gtk-layer-shell-sys)
[![dependency status](https://deps.rs/crate/gtk-layer-shell-sys/0.3.0/status.svg)](https://deps.rs/crate/gtk-layer-shell-sys/0.3.0)
