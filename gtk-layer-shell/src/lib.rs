...
use gtk_layer_shell_sys as ffi;
...
mod auto;
pub use auto::{Edge, KeyboardMode, Layer};

#[cfg(feature = "v0_4")]
#[cfg_attr(docsrs, doc(cfg(feature = "v0_4")))]
pub use auto::{functions::major_version, functions::micro_version, functions::minor_version};
...
pub trait LayerShell: IsA<gtk::Window> {
    ...
    fn is_keyboard_interactivity(&self) -> bool {
        crate::auto::functions::is_keyboard_interactivity(self)
    }
    ...
    fn set_keyboard_interactivity(&self, interactivity: bool) {
        crate::auto::functions::set_keyboard_interactivity(self, interactivity);
    }
